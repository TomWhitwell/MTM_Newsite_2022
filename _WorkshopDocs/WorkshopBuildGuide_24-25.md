...
NB: This is the build guide for kits bought BEFORE July 2025. [For newer kits, use this version.](/Workshop_System_Build_Guide/). The difference is not electronic, but how the kits are packed by Thonk. In July 2025, new packing - more compact and easier to understand - was introduced. 
