...
* If you're comfortable soldering but are a new builder, start by [watching the build video above](https://www.youtube.com/watch?v=-fjmAFyHc2Y). It's me (Tom, Music Thing Designer) talking through the entire build process in real time. Maybe the closest thing you can get to an online build workshop. 
* That video is the same length as Lawrence of Arabia, but not quite as dramatic. 
...
* [Join the Workshop System Discord](/discord/) - musicians and coders using and developing the system. 
...
* [VIDEO LINK: Assembling the case](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=477s). 
...
* [VIDEO LINK: Assembling the PSU](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=895s). 
...
* The PSU has four amber LEDs which show if power is OK. If any of the LEDS aren't lit, the most likely culprit is a USB power supply that doesn't put out 15V. 
...
* [VIDEO LINK: Soldering the piezo mic](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=1183s)
...
\
In [this section of the build video](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=1572s), I talk through and explain all the parts on a complete Workshop System, explaining what goes where and what to look out for. 
...
1. **VCF / Filters** Maybe the fiddliest board mechanically, with ON-ON switches that are tricky to nudge through the panel, close-packed LEDs and pushbuttons.  
1. **Mix** Two types of switches, dense pots, and lots to fit into a small space. 
\
...
* [VIDEO LINK: Building the VCO](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=2202s)
* PCB photos: 
...
* [VIDEO LINK: Building the Computer](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=4210s)
* PCB photos 
...
* **LED SPACERS** Kits include three tiny plastic spacers to protect the legs of Computer LEDs. Add them to the LEDs on the left hand side of Computer, close to the edge of the PCB. Orientation of the plastic spacers doesn't matter, but be careful to still put the long legs through the holes marked with +. 
...
* [VIDEO LINK: Building the VCF](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=6060s)
* PCB photos 
...
* This is a bit fiddly mechanically
...
* [VIDEO LINK: Building Mix](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=8217s)
* PCB photos
...
* This is another dense board, so maybe build it in two stages. 
...
* [VIDEO LINK: Putting it all together](https://www.youtube.com/watch?v=-fjmAFyHc2Y&t=9920s)
