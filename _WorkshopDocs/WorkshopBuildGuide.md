...
\
The Workshop System might be the most complicated thing you’ve ever built. Even for an experienced DIYer, there’s a lot to put together. But it's relatively quick (2-4 hours) and a very satisfying build. At the end you have an entire synthesiser!  \
\
The circuit boards are already populated with over 650 tiny components. Your job is to attach the interface elements: pots, knobs, switches, sockets (so many sockets), and LEDs.\
\
...
* If you're comfortable soldering but are a new builder, start by [watching the build video above](https://www.youtube.com/watch?v=M3mMAsjv3QE).
* It's me (Tom, Music Thing Designer) talking through the entire build process in real time. Maybe the closest thing you can get to an online build workshop. 
* It's the same length as Gladiator or Pulp Fiction, but not quite as dramatic. 
...
1. **[Build the Computer](#building-the-computer)**
...
* [Sign up the the Workshop System Newsletter](https://workshopsystem.substack.com/) - for new program cards, gigs, demos, patch ideas, collaboration opportunities, workshops and so on.
...
* Apart from the kit, you'll need: 
	* A USB-C PD power supply that can give 15 Volts, to power the system when you're finished. 
	* A soldering iron. Something with temperature control and a clean fine tip. It doesn't need to be tiny, but can't bee huge. 
...
* The position is marked. Tape the disk down and solder the three dots. It's quite a large area, so hold the soldering iron down for 5-10 seconds to heat it through before trying to solder. 
...
\
High resolution photos of the Rev1 boards: 
* **Computer** Bare: [Front](/images/Computer_Front.JPG) [Back](/images/Computer_back.JPG)  Populated: [Front](/images/computer_pop_front.jpg ) [Back](/images/computer_pop_back.jpg ) [Side](/images/computer_pop_side.jpg )
* **VCO** Bare: [Front](/images/VCO_Front.JPG) [Back](/images/VCO_back.JPG)  Populated: [Front](/images/VCO_pop_front.jpg ) [Back](/images/VCO_pop_back.jpg ) [Side](/images/VCO_pop_side.jpg )
* **VCF** Bare: [Front](/images/VCF_Front.JPG) [Back](/images/VCF_back.JPG)  Populated: [Front](/images/VCF_pop_front.jpg ) [Back](/images/VCF_pop_back.jpg ) [Side](/images/VCF_pop_side.jpg )
* **Mix** Bare: [Front](/images/Mix_Front.JPG) [Back](/images/Mix_back.JPG)  Populated: [Front](/images/mix_pop_front.jpg )  [Side](/images/mix_pop_side.jpg )
...
* First, mount all the components on the PCB, without soldering anything (apart from the power header, which is already in place) 
	* Check pots are all the right type and value 
...
{% include linkedHeading.html heading="Building the Computer" level=2 %}
...
* Computer is build in exactly the same way, with a few different details 
...
* Use a bit of tape or blu-tak to line LEDs up to the panel before soldering 
* Ensure the long LED legs go through the hole marked +. Don't rush it, it's annoying to fix later
* The SD Card is a little fiddly. Maybe do this separately, after all the other components. Use a bit of tape or blu-tak to hold it in place. It has very small pins, be careful when soldering to avoid shorts from big solder blobs.
...
* The pushbuttons need to be held in place before they're soldered. I use a little finger to push them up from behind, soldering one of the mechanical pins before checking that they're moving smoothly. You might also use blu-tak to hold them in place. Take it slow. 
