...
output: false
page-name: "Radio as Instrument"
permalink: "/Radio_As_Instrument/"
order: 4
title: "Radio as Instrument"
description: "John Cage, Stockhausen and music made with radio."
...
{% include linkedHeading.html heading="John Cage & Don Buchla" level=2 %}
...
> *Don Buchla, from an [interview transcript at the Vasulka archive](http://www.vasulka.org/archive/RightsIntrvwInstitMediaPolicies/IntrvwInstitKaldron/61/BuchlaTranscription.pdf)* 

{% include linkedHeading.html heading="Karlheinz Stockhausen" level=2 %}
...
{% include linkedHeading.html heading="Other inspiration" level=2 %}

<div class="documentation-video">
  <iframe src="https://www.youtube.com/embed/nE4H1mJB0eU" title="Scanner interview" loading="lazy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
- Akufen's 2002 debut album "My Way"... was entirely built around a series of tiny unrecognizable samples Leclair took from local FM radio. ([Source](http://www.higher-frequency.com/e_database/dj_producer/akufen/index.htm))  
...
Sources:   
http://www.theguardian.com/music/2009/aug/06/john-cage-symphony-for-radios  
http://en.wikipedia.org/wiki/List_of_compositions_by_John_Cage  
http://en.wikipedia.org/wiki/Kurzwellen  
http://monoskop.org/log/?p=4822
