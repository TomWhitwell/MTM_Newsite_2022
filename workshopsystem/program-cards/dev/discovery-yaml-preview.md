---
layout: default
title: Discovery YAML Preview
permalink: /workshopsystem/program-cards/dev/discovery-yaml-preview/
hide: true
noindex: true
sitemap:
  exclude: "yes"
...
<div class="program-cards program-card-preview-tool" data-preview-mode="split" id="discovery-yaml-preview">
  <header class="program-card-preview-tool__header">
    <div>
      <h1>Discovery YAML Preview</h1>
      <p>Edit discovery.yml in the left pane. The preview uses the current cards.yml and tags.yml data, and updates in the browser only.</p>
    </div>
  </header>
  ...
  <div class="program-card-preview-tool__panels" data-preview-panels>
    <section class="program-card-preview-tool__panel is-active" data-preview-panel="yaml">
      ...
      <textarea spellcheck="false" data-yaml-input aria-label="Discovery YAML"></textarea>
    </section>
...
<script>
  window.addEventListener('DOMContentLoaded', function () {
    ProgramCardPreviewTools.setupDiscoveryPreview({
      rootSelector: '#discovery-yaml-preview',
      discovery: {{ site.data.program_cards.discovery | jsonify }},
